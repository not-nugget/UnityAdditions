namespace UnityAdditions.Vector4
{
    ...
    public static class Vector4Extensions
    {
        ...
        /// </summary>
        /// <param name="v">Vector4 instance this method operates on</param>
        public static void ClampValuesPositive(this ref Vector4 v)
        {
            v.x = (v.x < 0f) ? 0 : v.x;
            v.y = (v.y < 0f) ? 0 : v.y;
            v.z = (v.z < 0f) ? 0 : v.z;
        ...
        /// </summary>
        /// <param name="v">Vector4 instance this method operates on</param>
        public static void ClampValuesNegative(this ref Vector4 v)
        {
            v.x = (v.x > 0f) ? 0 : v.x;
            v.y = (v.y > 0f) ? 0 : v.y;
            v.z = (v.y > 0f) ? 0 : v.z;
        ...
        /// <param name="suppressWarnings">Suppress warnings which would otherwise be generated by this method</param>
        public static void ClampValuesBetween(this ref Vector4 v, Vector4 minMax, bool suppressWarnings = false)
        {
            ...
            v.w = (v.w < -minMax.w) ? -minMax.w : (v.w > minMax.w) ? minMax.w : v.w;
        }
        ...
        /// <param name="suppressWarnings">Suppress warnings which would otherwise be generated by this method</param>
        public static void ClampValuesBetween(this ref Vector4 v, Vector4 min, Vector4 max, bool suppressWarnings = false)
        {
            if (min == max)
            {
                if (!suppressWarnings || !UnityAdditionSettings.SuppressWarnings)
        ...
        /// <param name="zMinMax">Range to randomize between -<paramref name="wMinMax"/> and <paramref name="wMinMax"/>. Zero behavior dependant on <paramref name="ignoreWhenZero"/> parameter</param>
        ...
        /// <param name="suppressWarnings">Suppress warnings which would otherwise be generated by this method</param>
        public static void ClampValuesBetween(this ref Vector4 v, float xMinMax = 0f, float yMinMax = 0f, float zMinMax = 0f, float wMinMax = 0f, bool ignoreWhenZero = true, bool suppressWarnings = false)
        {
            ...
            v.w = (zMinMax == 0) ? (ignoreWhenZero) ? v.w : 0 : (v.w < -wMinMax) ? -wMinMax : (v.w > wMinMax) ? wMinMax : v.w;
        }
        ...
        /// <param name="wMin">Lower w value clamp. Zero behavior dependant on <paramref name="ignoreWhenZero"/> parameter</param>
        /// <param name="wMax">Upper w value clamp. Zero behavior dependant on <paramref name="ignoreWhenZero"/> parameter</param>
        ...
        /// <param name="suppressWarnings">Suppress warnings which would otherwise be generated by this method</param>
        public static void ClampValuesBetween(this ref Vector4 v, float xMin = 0f, float xMax = 0f, float yMin = 0f, float yMax = 0f, float zMin = 0f, float zMax = 0f, float wMin = 0f, float wMax = 0f, bool ignoreWhenZero = true, bool suppressWarnings = false)
        {
